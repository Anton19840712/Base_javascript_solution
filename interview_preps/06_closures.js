var result = doCount()
console.log(result()) // заметь, что здесь ты пишешь result(), а не result
console.log(result())
console.log(result())

function doCount() {
	var counter = 0 // везде counter пишешь, да и все.
	function countMe() {
		counter = counter + 1
		return counter
	}
	return countMe // здесь ты возвращаешь функцию
}
